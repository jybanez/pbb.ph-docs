...
| PBB Kit Setup | `C:\wamp64\www\pbb\kit-setup` | Yes | Electron/PHP/PowerShell setup tool; current local version `0.1.163` bundles Landing, MapServer, Maestro, Realtime, Relay, Hotline, and Support |
